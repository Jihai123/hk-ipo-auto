...
const FALLBACK_SPONSORS  = {
  '金利丰财务顾问有限公司': { winRate: 100.00, count: 4 },
  '耀才资本有限公司': { winRate: 100.00, count: 4 },
  '大摩财务顾问有限公司': { winRate: 100.00, count: 4 },
  '英高财务顾问有限公司': { winRate: 100.00, count: 4 },
  '时富融资有限公司': { winRate: 100.00, count: 4 },
  '新百利融资有限公司': { winRate: 100.00, count: 3 },
  '永丰金证券(亚洲)有限公司': { winRate: 100.00, count: 3 },
  '中国通海企业融资有限公司': { winRate: 100.00, count: 3 },
  '新鸿基有限公司': { winRate: 100.00, count: 3 },
  '英皇融资有限公司': { winRate: 100.00, count: 2 },
  '华富建业企业融资有限公司': { winRate: 100.00, count: 2 },
  '日进资本有限公司': { winRate: 100.00, count: 2 },
  '金英证券(香港)有限公司': { winRate: 100.00, count: 2 },
  '百德能证券有限公司': { winRate: 100.00, count: 1 },
  '英皇企业融资有限公司': { winRate: 100.00, count: 1 },
  '荷兰银行香港分行': { winRate: 100.00, count: 1 },
  '巴克莱亚洲有限公司': { winRate: 100.00, count: 1 },
  '惠丰资本控股有限公司': { winRate: 100.00, count: 1 },
  '嘉林资本有限公司': { winRate: 100.00, count: 1 },
  '某诚证券有限公司': { winRate: 100.00, count: 1 },
  '溢博资本有限公司': { winRate: 100.00, count: 1 },
  '华升资本有限公司': { winRate: 100.00, count: 1 },
  '卓信融资有限公司': { winRate: 100.00, count: 1 },
  '康证资本香港有限公司': { winRate: 100.00, count: 1 },
  '清科资本有限公司': { winRate: 100.00, count: 1 },
  '天风国际资本市场有限公司': { winRate: 100.00, count: 1 },
  '泛亚金融有限公司': { winRate: 100.00, count: 1 },
  '英时资本有限公司': { winRate: 100.00, count: 1 },
  '英德资本有限公司': { winRate: 100.00, count: 1 },
  '申万宏源融资(香港)有限公司': { winRate: 91.67, count: 12 },
  '交银国际(亚洲)有限公司': { winRate: 87.50, count: 24 },
  '中国银河国际证券(香港)有限公司': { winRate: 86.67, count: 15 },
  '某信资本有限公司': { winRate: 85.71, count: 7 },
  '八方金融有限公司': { winRate: 85.71, count: 7 },
  '凯基金融亚洲有限公司': { winRate: 85.71, count: 7 },
  '天财资本国际有限公司': { winRate: 83.33, count: 12 },
  '天泰金融服务有限公司': { winRate: 83.33, count: 6 },
  '丰盛融资有限公司': { winRate: 82.93, count: 41 },
  '南华融资有限公司': { winRate: 80.00, count: 10 },
  '中毅资本有限公司': { winRate: 80.00, count: 5 },
  '上银国际有限公司': { winRate: 80.00, count: 5 },
  '天达融资亚洲有限公司': { winRate: 80.00, count: 5 },
  '德健融资有限公司': { winRate: 79.17, count: 24 },
  '中信证券(香港)有限公司': { winRate: 77.19, count: 57 },
  '同人融资有限公司': { winRate: 76.19, count: 21 },
  '浩德融资有限公司': { winRate: 75.00, count: 16 },
  '申银万国融资(香港)有限公司': { winRate: 75.00, count: 8 },
  '里昂证券资本市场有限公司': { winRate: 75.00, count: 4 },
  '鼎佩证券有限公司': { winRate: 75.00, count: 4 },
  '国元融资(香港)有限公司': { winRate: 75.00, count: 4 },
  '国信证券(香港)融资有限公司': { winRate: 75.00, count: 4 },
  '博恩融资有限公司': { winRate: 75.00, count: 4 },
  '汇盈融资有限公司': { winRate: 70.00, count: 30 },
  '广发融资(香港)有限公司': { winRate: 70.00, count: 20 },
  '创升融资有限公司': { winRate: 69.70, count: 33 },
  '西证(香港)融资有限公司': { winRate: 69.23, count: 13 },
  '创侨国际有限公司': { winRate: 69.23, count: 13 },
  '富比资本有限公司': { winRate: 68.75, count: 16 },
  '申万宏源融资(香港)有限公司': { winRate: 68.18, count: 22 },
  '招商证券(香港)有限公司': { winRate: 67.44, count: 43 },
  '中国平安资本(香港)有限公司': { winRate: 66.67, count: 9 },
  '东方融资(香港)有限公司': { winRate: 66.67, count: 9 },
  '建银融资有限公司': { winRate: 66.67, count: 9 },
  '联昌证券有限公司': { winRate: 66.67, count: 6 },
  '汇盈融资有限公司': { winRate: 66.67, count: 3 },
  '东英亚洲有限公司': { winRate: 66.67, count: 3 },
  '脉搏资本有限公司': { winRate: 66.67, count: 3 },
  '海通国际资本有限公司': { winRate: 64.29, count: 84 },
  '国泰君安融资有限公司': { winRate: 64.20, count: 81 },
  '美林远东有限公司': { winRate: 62.50, count: 48 },
  '中国光大融资有限公司': { winRate: 62.50, count: 40 },
  '工银国际融资有限公司': { winRate: 62.50, count: 24 },
  '力高企业融资有限公司': { winRate: 62.50, count: 24 },
  '民银资本有限公司': { winRate: 62.50, count: 16 },
  '铠盛资本有限公司': { winRate: 61.54, count: 13 },
  '中信证券融资(香港)有限公司': { winRate: 61.54, count: 13 },
  '招银国际融资有限公司': { winRate: 61.40, count: 57 },
  '浦兴亚洲有限公司': { winRate: 61.11, count: 18 },
  '瑞士信贷(香港)有限公司': { winRate: 60.00, count: 40 },
  '光银国际资本有限公司': { winRate: 60.00, count: 5 },
  '长江证券融资(香港)有限公司': { winRate: 60.00, count: 5 },
  '摩根士丹利亚洲有限公司': { winRate: 59.29, count: 140 },
  '信达国际融资有限公司': { winRate: 58.33, count: 24 },
  '东兴证券(香港)有限公司': { winRate: 58.33, count: 12 },
  '兴业金融融资有限公司': { winRate: 57.14, count: 7 },
  '德意志证券亚洲有限公司': { winRate: 56.52, count: 23 },
  '德意志银行香港分行': { winRate: 56.25, count: 16 },
  '富强金融资本有限公司': { winRate: 56.25, count: 16 },
  '中信建投(国际)融资有限公司': { winRate: 56.00, count: 50 },
  '浦银国际融资有限公司': { winRate: 55.56, count: 9 },
  '智富融资有限公司': { winRate: 55.56, count: 9 },
  '第一上海融资有限公司': { winRate: 54.55, count: 11 },
  '中银国际亚洲有限公司': { winRate: 53.33, count: 45 },
  '农银国际融资有限公司': { winRate: 52.17, count: 46 },
  '高盛(亚洲)有限责任公司': { winRate: 51.75, count: 114 },
  '交银国际(亚洲)有限公司': { winRate: 51.28, count: 39 },
  '华泰金融控股(香港)有限公司': { winRate: 50.67, count: 75 },
  '中国国际金融香港证券有限公司': { winRate: 50.41, count: 244 },
  '摩根大通证券(亚太)有限公司': { winRate: 50.00, count: 18 },
  '域高融资有限公司': { winRate: 50.00, count: 8 },
  '兴证国际融资有限公司': { winRate: 50.00, count: 8 },
  '越秀融资有限公司': { winRate: 50.00, count: 4 },
  '华兴证券(香港)有限公司': { winRate: 50.00, count: 4 },
  '侨丰融资有限公司': { winRate: 50.00, count: 2 },
  '麦格理资本证券股份有限公司': { winRate: 50.00, count: 2 },
  '长雄证券有限公司': { winRate: 50.00, count: 2 },
  '华邦融资有限公司': { winRate: 50.00, count: 2 },
  '兴业侨丰融资有限公司': { winRate: 50.00, count: 2 },
  '建勤环球金融服务有限公司': { winRate: 50.00, count: 2 },
  '瑞穗证券亚洲有限公司': { winRate: 50.00, count: 2 },
  '创越融资有限公司': { winRate: 50.00, count: 2 },
  '东吴证券国际融资有限公司': { winRate: 50.00, count: 2 },
  '实德新源资本有限公司': { winRate: 50.00, count: 2 },
  '建信国际有限公司': { winRate: 50.00, count: 2 },
  '卓亚(企业融资)有限公司': { winRate: 50.00, count: 2 },
  '花旗环球金融亚洲有限公司': { winRate: 48.57, count: 70 },
  '建银国际金融有限公司': { winRate: 48.15, count: 81 },
  '瑞士银行香港分行': { winRate: 47.62, count: 21 },
  '中达证券资本市场有限公司': { winRate: 47.46, count: 59 },
  '磐石亚洲融资有限公司': { winRate: 46.67, count: 15 },
  '泰邦资本股份有限公司': { winRate: 46.15, count: 26 },
  '均益融资有限公司': { winRate: 43.75, count: 16 },
  '凯银证券(香港)有限公司': { winRate: 42.86, count: 7 },
  '华富嘉升财务顾问有限公司': { winRate: 42.86, count: 7 },
  '瑞邦证券香港有限公司': { winRate: 42.19, count: 64 },
  '富途金融集团香港有限公司': { winRate: 41.67, count: 12 },
  '香港上海汇丰银行有限公司': { winRate: 41.38, count: 29 },
  '摩根大通证券(远东)有限公司': { winRate: 40.00, count: 55 },
  '法国巴黎证券(亚洲)有限公司': { winRate: 40.00, count: 35 },
  '美林(亚太)有限公司': { winRate: 36.84, count: 19 },
  '中泰国际融资有限公司': { winRate: 36.36, count: 11 },
  '大华继显(香港)有限公司': { winRate: 33.33, count: 3 },
  '安信融资(香港)有限公司': { winRate: 30.00, count: 10 },
  '渣打证券(香港)有限公司': { winRate: 25.00, count: 4 },
  '大和资本市场香港有限公司': { winRate: 25.00, count: 4 },
  '红日资本有限公司': { winRate: 22.22, count: 9 },
  '野村国际(香港)有限公司': { winRate: 16.67, count: 6 },
  '齐鲁国际融资有限公司': { winRate: 0.00, count: 2 },
  '中州国际融资有限公司': { winRate: 0.00, count: 2 },
  'TUS Corporate Finance Limited': { winRate: 0.00, count: 1 },
  '工银国际证券有限公司': { winRate: 0.00, count: 1 },
  '山证国际融资有限公司': { winRate: 0.00, count: 1 },
  '方正证券(香港)融资有限公司': { winRate: 0.00, count: 1 },
  '华金金融(国际)有限公司': { winRate: 0.00, count: 1 },
  '元大证券(香港)有限公司': { winRate: 0.00, count: 1 },
  '未来金融有限公司': { winRate: 0.00, count: 1 },
  '复星恒利证券有限公司': { winRate: 0.00, count: 1 },
  '茂宸环球资本有限公司': { winRate: 0.00, count: 1 },
  '香江资本有限公司': { winRate: 0.00, count: 1 },
  '财通国际融资有限公司': { winRate: 0.00, count: 1 },
  '宝来证券(香港)有限公司': { winRate: 0.00, count: 1 },
  '中投证券国际融资有限公司': { winRate: 0.00, count: 1 },
  '维诚资本有限公司': { winRate: 0.00, count: 1 },
  '千里硕融资有限公司': { winRate: 0.00, count: 1 },
};
...
console.log(`[基石投资者] 匹配结果: ${foundInvestorDetails.length}个 - ${foundInvestorDetails.map(d => d.keyword).join(', ') || '无'}`);
  ...
  const findAllKeywordHits = (srcText, keywords) => {
    ...
    for (const kw of keywords) {
      let from = 0;
      while (from < srcText.length) {
        const idx = srcText.indexOf(kw, from);
        if (idx < 0) break;
  ...
  const parseLockupMonths = (srcText) => {
    const monthPatterns = [
      { re: /(三十六個月|36個月|三十六个月|36个月)/i, value: 36 },
      { re: /(二十四個月|24個月|二十四个月|24个月)/i, value: 24 },
      { re: /(十二個月|12個月|十二个月|12个月)/i, value: 12 },
    ...
    for (const p of monthPatterns) {
      const m = srcText.match(p.re);
      if (m) months.push({ token: m[0], month: p.value });
    }
    return months;
  };
  const pickEvidenceSentence = (srcText, hitIndex) => {
    const start = Math.max(0, hitIndex - 90);
    const end = Math.min(srcText.length, hitIndex + 180);
  ...
  function findHistoryStartIndex() {
    for (const sp of HISTORY_SECTION_START_PATTERNS) {
      ...
      let m;
      while ((m = regex.exec(textNoSpaceForLockup)) !== null) {
        const start = m.index || 0;
        const after = textNoSpaceForLockup.slice(start + m[0].length, start + m[0].length + 30);
  ...
  const lockupEvidence = {
    ...
    hasLockup,
    lockupMonths,
    lockupPeriod: lockupMonths ? `${lockupMonths}个月` : '',
    sourceWindowType,
    score: lockupScore,
  ...
  const normalizeStockCodeString = (input) => {
    const digits = String(input ?? '').replace(/\D/g, '');
    if (!digits) return '';
    return digits.padStart(5, '0');
  };
  const extractInlineListingNameRecord = (html, currentStockCode) => {
    if (!html) return null;
    const targetCode = normalizeStockCodeString(currentStockCode);
    if (!targetCode) return null;

    const extractFieldValue = (snippet, key) => {
      if (!snippet) return null;
      const quoted = new RegExp(`["']?${key}["']?\\s*:\\s*(["'])([\\s\\S]*?)\\1`, 'i');
      const quotedMatch = snippet.match(quoted);
      if (quotedMatch?.[2]) return quotedMatch[2];
      const bare = new RegExp(`["']?${key}["']?\\s*:\\s*([^,}\\]\\n]+)`, 'i');
      const bareMatch = snippet.match(bare);
      return bareMatch?.[1] ? bareMatch[1].trim() : null;
    };

    const objectSnippetPattern = /\{[\s\S]{0,1800}?["']?stockcode["']?\s*:\s*["']?\d{1,5}["']?[\s\S]{0,1800}?\}/gi;
    const snippets = html.match(objectSnippetPattern) || [];
    for (const snippet of snippets) {
      const stockCodeValue = normalizeStockCodeString(extractFieldValue(snippet, 'stockcode'));
      if (!stockCodeValue || stockCodeValue !== targetCode) continue;
      return {
        stockcode: stockCodeValue,
        namechitc: cleanDisplayNameCandidate(extractFieldValue(snippet, 'namechitc')),
        namechisc: cleanDisplayNameCandidate(extractFieldValue(snippet, 'namechisc')),
        nameeng: cleanDisplayNameCandidate(extractFieldValue(snippet, 'nameeng')),
      };
    }
    return null;
  };
  ...
  const inlineListingNameRecord = extractInlineListingNameRecord(etnetHtml, stockCode);
  const inlineDisplayName = firstNonEmpty(
    inlineListingNameRecord?.namechitc,
    inlineListingNameRecord?.namechisc,
    inlineListingNameRecord?.nameeng,
  );
  console.log('[companyName][etnetInlineJson]', {
    stockCode: formatStockCode(stockCode),
    stockcode: inlineListingNameRecord?.stockcode || null,
    namechitc: inlineListingNameRecord?.namechitc || null,
    namechisc: inlineListingNameRecord?.namechisc || null,
    nameeng: inlineListingNameRecord?.nameeng || null,
  });
  ...
  const companyNameRegexFallback = cleanCompanyNameCandidate(
    sanitizeHtmlCellText(companyNameRegexFallbackMatch?.[1] || ''),
  );
  const etnetLegalCandidate = firstNonEmpty(
    ...companyNameHtmlCandidates.map(cleanCompanyNameCandidate),
  ...
  const legalCompanyName = firstNonEmpty(
    etnetLegalCandidate,
  ...
  const displayName = firstNonEmpty(
    inlineDisplayName,
    cleanDisplayNameCandidate(etnetLegalCandidate),
    cleanDisplayNameCandidate(companyNameProspectusFallback),
    legalCompanyName,
    stockCodeCandidate,
  );
  const sourceSelected = inlineDisplayName
    ? 'etnet_inline_json'
    : (etnetLegalCandidate ? 'etnet_page_legal_candidate' : (companyNameProspectusFallback ? 'prospectus' : 'stockCode'));
  console.log('[companyName][displayNameSelect]', {
    stockCode: formatStockCode(stockCode),
    displayName: displayName || null,
    sourceSelected,
    fallbackLegalCandidate: cleanDisplayNameCandidate(etnetLegalCandidate),
    fallbackProspectusCandidate: cleanDisplayNameCandidate(companyNameProspectusFallback),
  });
  console.log('[companyName][legalCandidates]', {
    stockCode: formatStockCode(stockCode),
    etnetPageCandidates: companyNameHtmlCandidates.map(v => cleanCompanyNameCandidate(v)).filter(Boolean),
    etnetRegexCandidate: companyNameRegexFallback || null,
    prospectusCandidate: companyNameProspectusFallback || null,
    legalCompanyName: legalCompanyName || null,
  });
  const companyName = displayName || stockCodeCandidate;
  console.log('[companyName][final]', {
    stockCode: formatStockCode(stockCode),
    namechitc: inlineListingNameRecord?.namechitc || null,
    namechisc: inlineListingNameRecord?.namechisc || null,
    nameeng: inlineListingNameRecord?.nameeng || null,
